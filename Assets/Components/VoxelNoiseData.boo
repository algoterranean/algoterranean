...
#using System.Graphics.Tools.Noise.Primitive
#import Graphics.Tools.Noise.Primitive



class VoxelNoiseData (MonoBehaviour):
	#gradient = NoiseGradient(50)
	#perlin = Perlin(3.5, 2.5, 0.4, 4, seed, QualityMode.High)	
