...
class BiomeNoiseData2 (INoiseData):
	...
	def constructor():
		...
		b2 = Primitive.Constant(BLOCK.SOLID cast int)
		b3 = Primitive.Constant(BLOCK.SWAMP cast int)
		...
		s1 = Modifier.Select(c, b1, b2, 0, 0.2, 0)
		s2 = Modifier.Select(c, s1, b3, 0, 0.3, 0)


		total_select = Modifier.Select(gradient, s2, Air, -1.0, 0.0, 0.0)
