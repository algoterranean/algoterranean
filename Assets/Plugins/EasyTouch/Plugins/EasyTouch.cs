...
public class EasyTouch : MonoBehaviour {
	...
	private bool CreateGesture(string message,Finger finger,float actionTime, SwipeType swipe, float swipeLength, Vector2 swipeVector){
	...
	private void SendGesture(string message, Gesture gesture){
	...
	private void  CreateGesture2Finger(string message,Vector2 startPosition,Vector2 position,Vector2 deltaPosition,
	...
	private void SendGesture2Finger(string message, Gesture gesture){
	...
	private void RaiseEvent(string evnt, Gesture gesture){
